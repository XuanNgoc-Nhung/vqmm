  ...
  let app = new Vue({
    ...
    methods: {
      ...
      prize_draw(num) {
        ...
        console.error('rotate_deg')
        console.error(vm.rotate_deg)

        vm.prize_transition = `all ${vm.duration / 1000}s cubic-bezier(0.42, 0, 0.2, 0.91)`
        console.error('prize_transition')
        console.error(vm.prize_transition)
        vm.time_remaining--
        vm.isClicked = true
